...
export default function PlaylistView({ showTitle = true, additionalClasses = "mt-20" }: PlaylistViewProps) {
                ...
                >
                  <div className="relative">
                    <Image
                      ...
                      width={64}
                      height={64}
                      className="rounded-md object-cover w-32 h-20 mr-4"
                      unoptimized={true}
                    />
                  ...
                  <div className="flex-grow text-left ml-2">
                    <button
                      className="text-sm font-medium text-white rounded-full w-full transition duration-300 text-left"
                      onClick={() => handleVideoClick(video._id)}
                    >
                      {video.title}
                    </button>
                    <p className="text-gray-300 text-sm">{video.ownerUsername}</p>
                  </div>
                  <button
